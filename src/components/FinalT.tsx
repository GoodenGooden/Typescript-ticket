  ...
  return (
    <div className="bg-[#02191D] text-white h-svh">
      ...
      <div className="relative">
        ...
        border-[#0E464F] border-solid w-[90%] md:w-2xl mt-60 md:mt-50 h-[44rem] rounded-3xl">
          ...
          <div className="flex justify-center gap-4 py-4 md:py-9">
