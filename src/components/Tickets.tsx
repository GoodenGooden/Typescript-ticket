...
export default function Tickets() {
    ...
    return (
        <div className="bg-[#02191D] text-white h-auto  min-h-screen flex flex-col overflow-hidden">
            ...
            <div className="relative flex-1 min-h-auto"> {/* Ensure full height and stretching */}
                <Border>
                    <div>
                    ...
                    <div className="relative min-h-auto"> {/* Ensure full height for the inner container */}
                        <div className="mx-auto w-[90%] md:w-[37rem] min-h-auto border border-[#0E464F] rounded-3xl">
                            <div className="m-8 h-36 rounded-3xl border-[#0E464F] border-solid border">
...
export default function Tickets() {
    ...
    return (
        <div className="h-auto bg-[#02191D] text-white">
            <div className="relative  ">
                <Search />
            </div>
            ...
            <Border>
                ...
                <ProgressBar title="Ticket Selection" step="Step" number1={1} number2={3}
                    ...
                    <div className="relative h-auto">
                        <div className="relative left-1/2 transform -translate-x-1/2 -translate-y-1/2 mt-68 w-[90%] md:w-[37rem] h-[32rem] border border-[#0E464F] rounded-3xl">
